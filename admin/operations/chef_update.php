...
session_start();
  if (isset($_POST['en'])) {
    ...
    move_uploaded_file($_FILES['picture']['tmp_name'],$upload);
        ...
        $sql="UPDATE chef set nom_com='$Nom',email='$Email',adresse='$Adresse',picture='$picture',salaire='$Salaire',speci='$specialité' WHERE id='$id'";
...
<form method="POST" enctype="multipart/form-data">
  ...
  <input type="text" name="Nom" class="form-control" id="floatingInput" placeholder="Nom"  value="<?php echo $value['nom_com'] ?>">
  <label for="floatingInput"> Nom</label>
</div>
<div class="form-floating">
  <input type="text" name="Email" class="form-control" id="floatingPassword" placeholder="Email" value="<?php echo $value['email'] ?>">
  <label for="floatingPassword">Email</label>
</div>
<div class="form-floating">
  <input type="text" name="Adresse" class="form-control" id="floatingPassword" placeholder="Adresse" value="<?php echo $value['adresse'] ?>">
  <label for="floatingPassword">Adresse</label>
</div>
<div class="form-floating">
  <input type="text" name="Salaire" class="form-control" id="floatingPassword" placeholder="Salaire" value="<?php echo $value['salaire'] ?>">
...
<div class="form-floating">
  <input type="text" name="specialité"  class="form-control" id="floatingPassword" placeholder="specialité" value="<?php echo $value['speci'] ?>">
